import random
import time
from Project.run2.source_code.datapreprocessing import calculateDistance
from Project.run2.source_code.mysqlUtilities import insertRecord, getRecords, getMinDistanceIntersection
...
tripWindow_end_time = "2016-05-17 06:00:00"
...
random_pool_Ids = list(range(7300000, 7400000))
random_trip_Ids = list(range(7300000, 7400000))
