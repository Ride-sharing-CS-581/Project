...
# Returns nearest intersection near to the destination considering 1.5 mile radius
def getNearestIntersections(destLat: str, destLong: str, precisionLong: str):
    query = "SELECT latitude, longitude, " \
            ...
            str(
                destLat) + ")) * sin(radians(latitude)))) AS distance FROM intersections HAVING distance < 1.50 ORDER " \
